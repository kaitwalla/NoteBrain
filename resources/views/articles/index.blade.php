                                ...
                                <div class="flex items-start justify-between p-4 bg-white border rounded-lg shadow-sm">
                                    ...
                                    <div class="ml-4 flex-shrink-0 flex space-x-2">
                                        ...
                                        <form method="POST" action="{{ route('articles.toggle-star', $article) }}" class="star-form">
                                            @csrf
                                            <button type="submit" class="p-1 text-gray-600 hover:text-gray-900 rounded-full" title="{{ $article->starred ? 'Unstar' : 'Star' }}">
                                                <svg class="w-5 h-5" fill="{{ $article->starred ? 'currentColor' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24">
